...
export default function ContactsView({
  ...
  return (
    <div>
      <PageHeader
        title={copy.title}
        subtitle={copy.subtitle(contacts.length)}
        actions={
          ...
          <table className="min-w-full">
            <thead className="bg-slate-50 dark:bg-slate-800/60 border-b border-slate-200 dark:border-slate-700">
              <tr>
                ...
                <th className="table-th">{copy.colCompany}</th>
                <th className="table-th">{copy.colEmail}</th>
                <th className="table-th">{copy.colPhone}</th>
                <th className="table-th">{copy.colStatus}</th>
                <th className="table-th">{copy.colAdded}</th>
      ...
      >
        <form onSubmit={submit} className="space-y-4">
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="label">{copy.firstName}</label>
              <input
                className="input"
                required
            ...
            <div>
              <label className="label">{copy.lastName}</label>
              <input
                className="input"
                required
                value={form.lastName}
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <label className="label">{copy.jobTitle}</label>
              <input
                className="input"
                value={form.title}
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              >
                <option value="">{copy.noCompany}</option>
                {companies.map((co) => (
          ...
          <div className="flex items-center justify-end gap-2 pt-2">
            ...
            <button type="submit" className="btn-primary" disabled={submitting}>
              {submitting ? copy.saving : form.id ? copy.saveChanges : copy.createContact}
            </button>
          </div>
        </form>
      </Modal>
