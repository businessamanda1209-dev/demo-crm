...
export default function Sidebar() {
  ...
  const links = [
    { href: "/", label: tx.nav.dashboard, icon: "M3 12 12 4l9 8M5 10v10h14V10" },
    { href: "/contacts", label: tx.nav.contacts, icon: "M16 14a4 4 0 1 0-8 0M4 20a8 8 0 1 1 16 0" },
    { href: "/companies", label: tx.nav.companies, icon: "M3 21h18M5 21V7l7-4 7 4v14M9 9h.01M9 13h.01M9 17h.01M15 9h.01M15 13h.01M15 17h.01" },
    { href: "/analytics", label: tx.nav.analytics, icon: "M3 3v18h18M7 14l4-4 4 4 5-5" },
  ];
  return (
